// Auto-generated from sRGB_IEC61966-2.1.icc (3144 bytes).
// IEC 61966-2.1:1999 sRGB color space profile, public domain.
#ifndef IDIFF_SRGB_ICC_H
#define IDIFF_SRGB_ICC_H
#include <cstddef>
#include <cstdint>
namespace idiff {
constexpr size_t kSrgbIccSize = 3144;
constexpr unsigned char kSrgbIcc[3144] = {
